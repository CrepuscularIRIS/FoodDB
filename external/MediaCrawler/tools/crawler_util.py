...
def show_qrcode(qr_code) -> None:  # type: ignore
    ...
    # Always save a copy so headless environments can access the QR image.
    output_path = Path("/tmp/media_crawler_qrcode.png")
    ...
    try:
        ...
        pass
    utils.logger.info(f"[show_qrcode] QR code image saved to {output_path}")
