...
class ZhihuCrawler(AbstractCrawler):
    ...
    async def start(self) -> None:
        ...
        async with async_playwright() as playwright:
            ...
            await self.context_page.goto(self.index_url, wait_until="domcontentloaded", timeout=config.PAGE_LOAD_TIMEOUT * 1000)
    ...
    async def launch_browser(
        ...
        if config.SAVE_LOGIN_STATE:
            ...
            browser = await chromium.launch(headless=headless, proxy=playwright_proxy, channel="chromium")  # type: ignore
